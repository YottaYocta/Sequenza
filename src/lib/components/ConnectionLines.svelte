<script lang="ts">
	import { endpointPositions } from './endpoint/endpoint';
	...
	const svgAttachment: Attachment<SVGSVGElement> = (element: SVGSVGElement) => {
		...
		function updateLines() {
			...
			const sortedPositions = [...endpointPositions].sort((a, b) => a.nodeIdx - b.nodeIdx);
...
<svg {@attach svgAttachment} class="absolute pointer-events-none -z-10"></svg>
