...
void main () {
    ...
    vec2 destination_r = destination + vec2(offset, 0.);
    ...
    vec2 destination_l = destination - vec2(offset, 0.);
    ...
    vec2 destination_u = destination + vec2(0., offset);
    ...
    vec2 destination_d = destination - vec2(0., offset);
