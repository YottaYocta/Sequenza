...
<div class="flex items-center gap-2 py-3">
	<div class="border p-2 bg-white relative">
		...
		<span class="absolute right-0 bottom-0 w-2 h-2 bg-black translate-1/2"> </span>
	...
	<div class="h-full flex flex-col gap-1">
		...
		<button onclick={triggerFileInput} class="button-1 outline hover:bg-neutral-200 relative">
			{currentImageData ? 'Change Image' : 'Upload Image'}
		</button>
		<button onclick={pasteFromClipboard} class="button-1 outline hover:bg-neutral-200 relative">
