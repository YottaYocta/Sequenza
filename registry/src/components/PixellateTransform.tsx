  ...
  return {
    ...
    "19699.031512972433": {
      u_gradientTexture: {
        ...
        stops: [
          {
            position: 0.21807853229828328,
            color: "#005bd9",
          },
          {
            position: 0.8108174444465548,
            color: "#5bd2ff",
          },
        ],
      },
...
function getPatch(): Patch {
  return {
    ...
    connections: [
      {
        from: "2918.358906881069",
        to: "50534.98755471239",
        input: "input_tex",
      },
      {
        from: "19699.031512972433",
        to: "2918.358906881069",
        input: "u_input",
      },
      {
        from: "31422.568902231964",
        to: "19699.031512972433",
        input: "u_texture",
      },
    ],
  };
