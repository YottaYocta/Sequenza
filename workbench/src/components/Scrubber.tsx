    ...
    <div className="flex items-center w-20 relative nodrag">
      ...
      >
        {isEditing ? (
          ...
          <span className="text-xs font-mono text-neutral-500 pl-5 pointer-events-none border-neutral-200 bg-white rounded-sm w-full h-full flex items-center justify-end px-1">
            <p>{displayValue}</p>
          </span>
        )}
      </div>
